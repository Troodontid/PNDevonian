...
public class BiomeDevonianCreekGilboa extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeDevonian {
		public BiomeGenCustom() {
			super(new BiomeProperties("Devonian Wattieza Forest Creek").setRainfall(0.7F).setBaseHeight(-0.525F).setHeightVariation(0.0F).setTemperature(0.6F).setWaterColor(14745518));
