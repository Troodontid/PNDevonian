...
public class BiomeDevonianForest extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeDevonian {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Devonian Forest").setRainfall(0.5F).setBaseHeight(0.2F).setHeightVariation(0.6F).setTemperature(0.5F).setWaterColor(14745518));
